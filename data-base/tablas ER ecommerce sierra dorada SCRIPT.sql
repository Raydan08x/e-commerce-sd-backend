CREATE DATABASE `e-commerce-sierra-dorada`;
...
CREATE TABLE categorias (
    ...
    CONSTRAINT fk_categoria_principal FOREIGN KEY (categoria_principal_id) REFERENCES categorias(id_categoria)
);
...
CREATE TABLE pedidos (
    ...
    CONSTRAINT fk_pedido_metodo_pago FOREIGN KEY (metodo_pago_id) REFERENCES metodos_pago(id_metodo_pago),
...
CREATE TABLE pagos (
    ...
    CONSTRAINT fk_pago_pedido FOREIGN KEY (pedido_id) REFERENCES pedidos(id_pedido) ON DELETE CASCADE,
    CONSTRAINT fk_pago_metodo FOREIGN KEY (metodo_pago_id) REFERENCES metodos_pago(id_metodo_pago)
);