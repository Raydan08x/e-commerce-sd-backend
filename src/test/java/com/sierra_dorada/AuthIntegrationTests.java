    ...
    void actualizaUsuarioSinReemplazarLaContrasena() throws Exception {
        String registro = """
            {"nombre":"Laura","apellidos":"Administradora","fechaNacimiento":"1992-04-15",
             ...
             "email":"laura.admin@example.com","password":"secreto123"}
            """;

        String respuestaRegistro = mvc.perform(post("/registro")
    ...
    private String registrarClienteYObtenerToken() throws Exception {
        String registro = """
            {"nombre":"Carlos","apellidos":"Cliente","fechaNacimiento":"1994-08-12",
             ...
             "email":"cliente.permisos@example.com","password":"secreto123"}
            """;

        String respuesta = mvc.perform(post("/registro")
                .contentType(MediaType.APPLICATION_JSON)
                .content(registro))
            .andExpect(status().isCreated())
            .andReturn()
